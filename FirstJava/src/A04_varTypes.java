...
public class A04_varTypes {
	...
	public static void main(String[] args) {
		 ...
		 * - short(2byte)
		 * - int(4byte)		*정수형 기본 타입*
		 * - loge(8byte)	큰 정수값을 표기하기 위해서
		 * 
		 * - 1byte (byte, char(c언어))
		 *   signed: -128 ~ 127, unsigned: 0~225
		...
		*/
		...
		long _long = 22_0000_0000L;	// long은 정수 뒤에 L(1을 붙여 사용)
		...
		// 데이터 타입은 소분자로 시작하는 타입: 기본 타입
		// 데이터 타입이 대문자로 시작하는 타입: 참조 타입
		String comment = "앞으로 약 35분 후에 점심입니다.";
		System.out.println(comment + _goon_pil);
	}
