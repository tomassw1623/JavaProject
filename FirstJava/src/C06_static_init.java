 ...
 *  - static 제한자는 지정된 변수와 메서드를 인스턴스와 무관하게 만들어 주기 때문에 this 를
 *  가질 수 없음
 *  - static 메서드는 non-static 메서드로 재정의 되 수 없음.
 *  - 변수
 ...
 *    > static 블럭에는 non-static 맴버를 직접 참조 못함.
 *    > 객체를 생성해 사용 가능
 *  - 클래스
...
class StaticInit{
	...
	static {  // 생성자가 실행되기 전에 static 변수를 초기화. 객체 여러번 생성해도 한번만!
