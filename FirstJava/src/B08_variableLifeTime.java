public class B08_variableLifeTime {
    ...
    static int c;    // 클래스 멤버 변수 - 클래스에 직접 사용하는 변수로 생성과 상관없이 사용 가능
    int b = 8;    // 인스턴스 멤버 변수 - 객체가 생성되어야 사용할 수 있음

    public static void main(String[] args) {
        // 변수 수명
        
        // {} 블록 내부에서 선언된 변수는 '지역변수'로 {}을 벗어나면 사라집니다.
        // 변수가 살아 있는 범위를 변수의 영역(scope)이라고 합니다.
        // 변수의 영역만 겹치지 않는다면 같은 이름의 변수를 사용할 수 있습니다.
        
        int b = 5;    // 지역변수
        System.out.println("main method의 b: " + b);
        c = 10;
        System.out.println("Class 멤버 변수 c: " + c);
        ...
        System.out.println("class의 b(obj2 인스턴스 멤버 변수) :" + obj2.b);
