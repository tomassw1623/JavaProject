/*
 	여러줄 주석
 		...
 		주석은 코드를 설혐하거나 기술할 때 사용해요.
 		
 	* 새 프로젝트 생성
 	  file -> new -> java project -> 프로젝스 입력
...
/*
  	JAVA특징
  	 - OOP(Objcet Oriented Programming) - 객체지향 프로그래밍
  	 => 수많은 객체들이 서로 상호작용으로 프로그래밍을 함!
  	 - 플랫폼 독립적(아키텍펴 중립적) -> 자바를 사용하는 가장 큰 이유
...
public class A01_HelloWorld {
	...
	public static void main(String[] args) { // {}(중괄호)블럭은 여러 명령어가 묶여 있는 부분
		...
		// ;(세미콜론) : 한 명령어의 끝을 알림.
		// System.out.println()메서드 : 콘솔에 ()안에 있는 입력 냐용을 출력하는 기능의 메서드
